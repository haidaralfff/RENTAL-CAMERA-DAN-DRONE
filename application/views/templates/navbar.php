    ...
    <div class="navbar-actions">
        ...
        ?>
            <div class="d-flex align-center gap-2">
                ...
                <div class="sidebar-avatar" style="width:34px;height:34px;font-size:13px;background:#E2E8F0;color:#475569"><?= strtoupper(substr($cu['nama'],0,1)) ?></div>
                <span style="font-weight:600;font-size:13px;margin-right:10px"><?= htmlspecialchars($cu['nama']) ?></span>
                
                <a href="<?= site_url('logout') ?>" class="btn btn-outline btn-sm" title="Logout">
                    <i class="fas fa-sign-out-alt"></i>
                </a>
            </div>
        <?php else: ?>
            <a href="<?= site_url('login') ?>"    class="btn btn-outline btn-sm">Login</a>
